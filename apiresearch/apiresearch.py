...
#import iexcredentials 
#token = iexcredentials.token

symbol = Stock("AAPL", token = "pk_5e280dbbce2c454dad7da42f83c4b58f")
a = symbol.get_company()
print(a)
...
df = get_symbols(output_format='pandas', token="pk_5e280dbbce2c454dad7da42f83c4b58f")
#---------------------------------------------------------------------------------------
...
#small change that may be applicable
# if this importe...
from pandas_datareader import data as pdr
#then yfinance can be overridden this way for faster download. 
